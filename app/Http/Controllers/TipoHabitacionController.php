...
class TipoHabitacionController extends Controller
{
    ...
    {
        //
        $respuesta['registros'] = TipoHabitacion::all()->toArray();
    ...
    public function store(Request $request)
    {
        try 
        {
            if ($request->input('nombre')) 
            {
                ...
                $registro->corto = $request->input('corto');
    ...
    {
        $registro = TipoHabitacion::find($id);
        if ($registro) 
        {
            $respuesta['registros'] = $registro->toArray();
            $respuesta['mensaje']   = 'Registros Obtenidos Correctamente';
    ...
    public function update(Request $request, $id)
    {
        ...
        try 
        {
            ...
            if ($registro) 
            {
                ...
                $registro->corto = $request->input('corto', $registro->corto);
