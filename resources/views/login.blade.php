    ...
    <div class="page-container">
        ...
        <div class="login-container">
            <form class="form-signin" id="form-login">
                <input type="text" class="form-control floatlabel" name="usuario" placeholder="Usuario" required autofocus>
                <input type="password" class="form-control floatlabel" name="password" placeholder="Clave" required>
                <button class="btn btn-primary btn-block btn-signin" type="submit">Ingresar</button>
            </form>
        </div>
        <div class="login-footer" style="color: black;">
            Creado Por <a href="http://alexmejicanos.com" target="_blanc">Alex Mejicanos</a>
