            ...
            <div class="col-md-7">
                <div class="page-breadcrumb-wrap">
                    ...
                    <div class="page-breadcrumb-info">
                        <h2 class="breadcrumb-titles">Tarifas <small>Administración de Tarifas</small></h2>
                    </div>
                </div>
            </div>
            <div class="col-md-5">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Crear Tarifa</h4>
            </div>
            <form id="form-crear">
            ...
            <form id="form-editar">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="control-label">Precio <span class="asterisk">*</span> </label>
...
<script type="text/javascript" src="js/tarifas.js"></script>